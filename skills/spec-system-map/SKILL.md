...
8. If the user is running the full spec pipeline, point them to the ready-to-commit checklist in `../spec-grill/references/spec-pipeline-ready.md` after the map and at least one accepted capability exist.
