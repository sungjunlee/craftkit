...
Four ideas behind a good prompt or a good minimal-diff edit. `craft-prompt` applies them when composing a new prompt; `craft-tune` applies them when judging whether an edit is a real improvement.
