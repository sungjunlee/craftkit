...
Run an eval-driven autonomous optimization loop on a prompt or skill. Adapted for CraftKit artifacts from Andrej Karpathy's [autoresearch](https://github.com/karpathy/autoresearch) (the ML training-loop project that introduced the methodology), with implementation patterns drawn from the [jangpm-meta-skills](https://github.com/byungjunjang/jangpm-meta-skills) autoresearch skill.
